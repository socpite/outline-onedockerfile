#!/usr/bin/python3
"""
Outline Import Script - Robust Python Version
Fixes encoding issues, foreign key handling, and provides proper transaction support.
"""
...
class OutlineImporter:
    ...
    def import_data(self, data: Dict[str, Any]) -> Dict[str, int]:
        ...
        try:
            ...
            self.grant_full_permissions_to_all_users()
